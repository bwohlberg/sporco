...
RUN wget -q -P sporco/data/kodak http://r0k.us/graphics/kodak/kodak/kodim23.png
RUN wget -q -P sporco/data/standard http://homepages.cae.wisc.edu/~ece533/images/monarch.png
